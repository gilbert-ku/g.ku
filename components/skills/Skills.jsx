...
const Skills = () => {
  return (
    <>
    <div className='mt-5 container mx-auto px-4 md:px-1 mb-3 md:my-12' id='Skills'>
        <h1 className='text-2xl md:text-5xl text-center text-white font-semibold mb-5 md:my-10'>Professional <span className='text-light-blue-600'>Skills.</span></h1>
