        ...
        <div className="md:flex mt-3 md:mt-12">
          ...
          />
            ...
            <div className='md:ml-5 lg:ml-10 my-auto md:pr-5 lg:pr-3'>
              ...
              <button className='mt-3 md:mt-5 lg:mt-9 p-3 bg-blue-gray-900 w-full md:w-16 h-full md:h-16 rounded-full flex justify-center items-center align-bottom'>
                {/* <h1 className='pr-4 my-auto font-serif font-bold text-xl text-light-blue-600 md:hidden'>go live</h1> */}
                <Link href="https://estateeaseapp.onrender.com/" target='_blank' className='text-light-blue-600 text-xl md:text-2xl font-semibold md:font-bold flex'> <h1 className='pr-4 my-auto font-serif font-bold text-xl text-light-blue-600 md:hidden'>go live</h1><FaExternalLinkAlt /></Link>
              </button>
            </div>
        </div>
